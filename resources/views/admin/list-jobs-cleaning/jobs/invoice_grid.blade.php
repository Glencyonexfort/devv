...
{{-- Start:: invoice items --}}                
            ...
            @foreach($invoice_items as $item)
                ...
                <tr id="invoice_line_div_edit_{{ $item->id }}" class="bgblu hidden" data-row="0">
                    <td>
                        <span>
                            <div class="form-group">
                                ...
                                <input id="invoice_description_edit_{{ $item->id }}" class="form-control mt-1" name="description" value="{{ $item->item_summary }}" placeholder="Description"/>
                            </div>
                        </span>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <input type="hidden" id="invoice_total_edit_field_{{ $item->id }}" value="{{ $item->amount }}"/>
    ...
    <tr id="invoice_line_div_new" class="bgblu invoice_line_div hidden" data-row="0">
        <td>
            <span>
                <div class="form-group">
                    ...
                    <input class="invoice_description_new form-control mt-1" name="description" value="" placeholder="Description"/>
                </div>
            </span>
        </td>
        <td>
        ...
        <td>
            ...
            <input type="hidden" class="invoice_total_new_field"/>
...
<div class="form-group row" style="margin: 4rem 0 .4rem!important;">    
    <h3 class="col-lg-2" style="font-weight: 500;font-size: 14px;padding-left: 0px;">Charges</h3>
</div>           
<table class="inventory">
    <tbody>
        @if(count($invoice_charges))
                ...
                <span>
                    <div class="form-group">
                        <select class="form-control invoice_charge_new">
                            <option value="0"></option>
                            @foreach($charges as $product)
                            <option value="{{ $product->name }}" data-pid="{{ $product->id }}" data-desc="{{ $product->description }}" data-price="{{ $product->price }}" data-tax="{{ $product->tax_id }}" 3data-type="{{ $product->product_type }}">{{ $product->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </span>
...
<table class="balance" style="margin-top: 3rem;">
    ...
    <?php
        $total_tax = ($rate_percent * $total_excl_tax_after_discount)/100;
