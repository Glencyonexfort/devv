            ...
            <div style="flex:auto">
                <div class="card">
                    <div class="card-header bg-white header-elements-inline">
                        <h6 class="card-title">@lang('modules.smsTemplates.createTitle')</h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email_subject" id="email_subject" class="form-control" autocomplete="nope">
                                        </div>
                                    </div>
                                </div>    -->
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">@lang('modules.smsTemplates.active')</label>
                                                <div class="switchery-demo">
                                                    <input type="checkbox" id="active" name="active" value="Y" class="js-switch " data-color="#f96262" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@push('footer-script')
    ...
    <script>
        ...
        $('#save-form').click(function() {
            var data = $('#createTemplate').serialize();
            console.log(data);
            $.easyAjax({
                url: "{{ route('admin.sms-templates.store') }}",
