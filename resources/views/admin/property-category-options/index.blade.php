                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <a href="{{ route('admin.property-category-options.create') }}"
                                        class="btn btn-outline btn-success btn-sm">@lang('modules.propertyCategoryOptions.addNew')
                                        <i class="fa fa-plus" aria-hidden="true"></i></a>
                                </div>
                            </div>
                            {{-- <div class="col-sm-6 text-right hidden-xs">
                                <div class="form-group">
                                    <a href="javascript:;" onclick="exportData()" class="btn btn-info btn-sm"><i
                                            class="ti-export" aria-hidden="true"></i> @lang('app.exportExcel')</a>
                                </div>
                            </div> --}}
                        </div>
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover toggle-circle default footable-loaded footable"
                                id="listing-table" style="font-size:13px;width:100%!important;">
                                <thead>
                                    <tr>
                                        <th>@lang('modules.propertyCategoryOptions.property_cateogry')</th>
                                        <th>@lang('modules.propertyCategoryOptions.property_category_option')</th>
...
@push('footer-script')
    ...
    @elseif($global->locale == 'pt-br')
        <script
            src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.7.1/locales/bootstrap-datepicker.pt-BR.min.js">
        </script>
    @else
        <script
    ...
    <script>
            ...
            $('body').on('click', '.sa-params', function() {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        var url = "{{ route('admin.property-category-options.destroy', ':id') }}";
        ...
        function loadTable() {
            ...
            table = $('#listing-table').dataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{!!  route('admin.property-category-options.data') !!}",
                "order": [
                    [0, "desc"]
                ],
                language: {
        ...
        function exportData() {
            var url = "{{ route('admin.property-category-options.export') }}";
