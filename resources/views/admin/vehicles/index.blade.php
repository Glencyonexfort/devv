        ...
        <div class="white-box">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <a href="{{ route('admin.vehicles.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.vehicles.addNew') <i class="fa fa-plus" aria-hidden="true"></i></a>
                    </div>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover toggle-circle default footable-loaded footable" id="listing-table" style="font-size:13px;width:100%!important;">
                    <thead>
                        <tr>
                            <th>@lang('modules.vehicles.name')</th>
                            <th>@lang('modules.vehicles.license_plate')</th>
                            <th>@lang('modules.vehicles.vehicle_in_tons')</th>
...
//                                    swal("Deleted!", response.message, "success");
                            ...
                            function exportData(){
                            var url = '{{ route('admin.vehicles.export') }}';
