                    ...
                    <div class="white-box">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <a href="{{ route('admin.leaseQuoteFormSettings.create') }}"
                                        class="btn btn-outline btn-success btn-sm">@lang('modules.leaseQuoteFormSettings.addNew')
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover toggle-circle default footable-loaded footable"
                                ...
                                <thead>
                                    <tr>
                                        <th>@lang('modules.leaseQuoteFormSettings.servicing_city')</th>
    ...
    <script>
            ...
            $('body').on('click', '.sa-params', function() {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        var url = "{{ route('admin.leaseQuoteFormSettings.destroy', ':id') }}";
        ...
        function loadTable() {
            ...
            table = $('#listing-table').dataTable({
                ...
                serverSide: true,
                // searching: false,
                ajax: "{!!  route('admin.leaseQuoteFormSettings.data') !!}",
                "order": [
                    [0, "desc"]
                ],
                language: {
