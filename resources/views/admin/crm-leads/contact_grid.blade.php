...
<ul class="media-list">
    <li class="media broderline1 contact_grid_1" style="border-bottom: none!important;">
        ...
        <!-- <div class="ml-3 align-self-center">
            <div class="list-icons">
                <a data-contactid="{{ $contact->id }}" data-leadid="{{ $lead_id }}" class="contact-expand-btn list-icons-item mr-2 cursor-pointer" title="Expand"><i class="icon-profile"></i></a>
                <a data-contactid="{{ $contact->id }}" data-leadid="{{ $lead_id }}" class="contact-update-btn list-icons-item mr-2 cursor-pointer" title="Edit"><i class="icon-pencil5"></i></a>
                <a data-contactid="{{ $contact->id }}" data-leadid="{{ $lead_id }}" class="contact-remove-btn list-icons-item mr-2 cursor-pointer" title="Delete"><i class="icon-bin"></i></a>
            </div>
        </div> -->
    </li>
</ul>
