...
<script>
    ...
    function loadTable() {
        ...
        var url = '{!! route("admin.crm-leads.commercialData") !!}?created_date_start=' + created_date_start + '&created_date_end=' + created_date_end + '&lead_status=' + lead_status + '&sorting_order=' + sorting_order + '&sort_descending=' + sort_descending;
            console.log(url);
        ...
        table = $('#listing-table').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route("admin.crm-leads.commercialData") !!}?created_date_start=' + created_date_start + '&created_date_end=' + created_date_end + '&lead_status=' + lead_status + '&sorting_order=' + sorting_order + '&sort_descending=' + sort_descending,
