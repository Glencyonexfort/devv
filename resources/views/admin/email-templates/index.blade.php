            ...
            <div class="col-md-12">
                <div class="white-box" style="padding: 25px 0px;">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <a href="{{ route('admin.email-templates.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.emailTemplates.addNew') <i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    ...
                    <table class="table table-responsive" id="listing-table" style="font-size:13px;width:100%!important;">
                        <thead>
                            <tr>
                                <th>@lang('modules.emailTemplates.email_template_name')</th>
