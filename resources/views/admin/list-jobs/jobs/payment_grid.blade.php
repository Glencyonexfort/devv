        ...
        <tbody>
            ...
            @foreach($payment_items as $item)
                ...
                <tr id="payment_line_div_edit_{{ $item->id }}" class="bgblu hidden" data-row="0">
                    ...
                    <td>
                        <span>
                            <textarea id="payment_description_edit_{{ $item->id }}" class="form-control mt-1" name="description" placeholder="Description">{{ $item->remarks }}</textarea>
                        </span>
                    </td>
                    <td>
                        <span>
...
<tr id="payment_line_div_new" class="bgblu payment_line_div hidden" data-row="0">
    ...
    <td>
        <span>
            <textarea class="payment_description_new form-control mt-1" name="description" placeholder="Description"></textarea>
        </span>
    </td>
    <td>
        <span>
...
?>
<input type="hidden" id="inv_balance_amount" value="{{ $balance_amount }}"/>
<table class="balance">
    <tr>
    ...
    <tr>
        ...
        <td><span id="grand_total_balance">{{$global->currency_symbol}}{{ $balance_amount }}</span></td>
    </tr>
</table>
</article>  