...
<div class="float-left">
    <button id="add_oppTrip_line_{{ $leg->id }}" type="button" class="btn btn-light plus_btn add_oppTrip_line" data-leg="{{ $leg->id }}"><i class="icon-plus3"></i></button>
</div>
</article>  
@endforeach
@endif
...
<table>
    <tr>
        <td colspan="4">No trip record found!</td>
    </tr>
</table>
@endif