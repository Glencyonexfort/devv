                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <a href="{{ route('admin.companies.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.companies.addNew') <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover toggle-circle default footable-loaded footable" id="listing-table" style="font-size:13px;width:100%!important;">
                        ...
                        <tr>
                            ...
                            <th>@lang('modules.companies.company_name')</th>
                            <th>@lang('modules.companies.address')</th>
                            <th>@lang('modules.companies.contact_name')</th>
                            <th>@lang('modules.companies.abn')</th>
                            <th>@lang('modules.companies.default')</th>
...
//                { data: 'id', name: 'id' },
    ...
    function exportData(){
        var url = '{{ route('admin.companies.export') }}';
