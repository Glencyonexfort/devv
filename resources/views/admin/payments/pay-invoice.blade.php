                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <h3 class="form-control-static">{{ ($invoice->currency && $invoice->currency->currency_symbol) ? $invoice->currency->currency_symbol : '$'.' '.$invoice->total }}</h3>
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>@lang('modules.invoices.paid')</label>
                                        <h3 class="form-control-static">{{ ($invoice->currency && $invoice->currency->currency_symbol) ? $invoice->currency->currency_symbol : '$'}} {{ $paidAmount }}</h3>
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>@lang('modules.invoices.due')</label>
                                        <h3 class="form-control-static">{{ ($invoice->currency && $invoice->currency->currency_symbol) ? $invoice->currency->currency_symbol : '$'}} {{ max(($invoice->total-$paidAmount),0) }}</h3>
                                    </div>
                                </div>
                                <!--/span-->
