...
@section('content')
    ...
    <div class="row dashboard-stats">
        ...
        {{--<div class="col-md-10"><i class="ti-gift"></i> @lang('modules.update.newUpdate') <label class="label label-success">{{ $updateVersionInfo['lastVersion'] }}</label></div>--}}
        {{--<div class="col-md-2"><a href="{{ route('admin.update-settings.index') }}" class="btn btn-success btn-small">@lang('modules.update.updateNow') <i class="fa fa-arrow-right"></i></a></div>--}}
        {{--</div>--}}
        {{--@endif--}}
                    ...
                    <div class="white-box">
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-right">
                                <span class="widget-title"> @lang('modules.dashboard.paymentLastMonth')</span><br>
                                <span class="counter">{{ $counts->paymentLastMonth }}</span>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="javascript:">
                    <div class="white-box">
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-right">
                                <span class="widget-title"> @lang('modules.dashboard.paymentThisMonth')</span><br>
                                <span class="counter">{{ $counts->paymentThisMonth }}</span>
                            </div>
                        </div>
                    </div>
                </a>
        ...
        @if(in_array('projects',$modules))
            <div class="col-md-3 col-sm-6">
                <a href="javascript:"> <!-- {{ route('admin.projects.index') }} -->
                    <div class="white-box">
                        <div class="row">
                            <div class="col-sm-3">
                                <div>
        ...
        @if(in_array('invoices',$modules))
            <div class="col-md-3 col-sm-6">
                <a href="javascript:"> <!-- {{ route('admin.all-invoices.index') }} -->
                    <div class="white-box">
                        <div class="row">
                            <div class="col-sm-3">
                                <div>
    ...
    <div class="row" >
        ...
        @if(in_array('employees',$modules))
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">@lang('modules.dashboard.unreadEmails')</div>
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover toggle-circle default footable-loaded footable" id="listing-table">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th>@lang('modules.dashboard.job_no')</th>
                                        <th>@lang('modules.dashboard.sender')</th>
                                        <th>@lang('modules.dashboard.subject')</th>
                                        <th>@lang('modules.dashboard.recieved')</th>
                                        <th>@lang('modules.dashboard.action')</th>
                                    </tr>
                                    </thead>
                                    @forelse($unreadEmails as $key=>$activity)
                                        <tr>
                                            <td>{{$key+1}}</td>
                                            <td>{{$activity->job_number}}</td>
                                            <td>{{$activity->email_from}}</td>
                                            <td>{{$activity->email_subject}}</td>
                                            <td>{{date('Y-m-d h:i A', strtotime($activity->log_date))}}</td>
                                            <td>
                                                <button
                                                        type="button"
                                                        class="email-as-read"
                                    ...
                                    @empty
                                        <tr><td colspan="6">@lang("messages.noUnreadEmails")</td></tr>
                                    @endforelse
                                </table>
                            </div>
                        </div>
...
@push('footer-script')
    <script>
        ...
        $('.email-as-read').click(function () {
            var id = $(this).data('id');
            var url = '{{ route("admin.setEmailAsRead") }}';
            $.easyAjax({
                type: 'POST',
                url: url,
