                ...
                <form action="" id="filter-form">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="select2 m-b-10 select2-multiple " multiple="multiple" data-placeholder="Choose Skills" name="skill[]" id="skill" data-style="form-control">
                                <option value="all">@lang('modules.client.all')</option>
...
<script>
    ...
    function loadTable() {
        ...
        table = $('#users-table').dataTable({
            ...
            destroy: true,
            stateSave: true,
            ajax: "{!! route('admin.employees.data') !!}?employee=" + employee + '&status=' + status + '&role=' + role + '&skill=' + skill,
            language: {
