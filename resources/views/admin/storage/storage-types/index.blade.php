    ...
    <!-- <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">@lang('app.menu.email_templates')</span>
            </div>
        </div>
    </div> -->
</div>
...
<div style="padding-top:25px">
    ...
    <div class="d-md-flex align-items-md-start">
        ...
        <div class="card" style="width: 100%;z-index: 3">
            <div class="col-md-12">
                <div class="white-box" style="padding: 25px 0px;">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <a href="{{ route('admin.storage-types.create') }}" class="btn btn-outline btn-success btn-sm">Add Storage Type <i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(function() {
        ...
        $('body').on('click', '.sa-params', function() {
            ...
            swal({
                title: "Are you sure?",
                text: "You will not be able to recover the deleted Storage Type!",
                type: "warning",
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('admin.storage-types.destroy',':id') }}";
    ...
    function loadTable() {
        ...
        table = $('#listing-table').dataTable({
            ...
            serverSide: true,
            autoWidth: false,
            ajax: "{!! route('admin.storage-types.data') !!}",
            "order": [
                [0, "desc"]
            ],
            language: {
    ...
    // function exportData() {
    //     var url = "{{ route('admin.email-templates.export') }}";
