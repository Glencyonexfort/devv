                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <a href="{{ route('admin.storage-units.create') }}" class="btn btn-outline btn-success btn-sm">Add Storage Unit <i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(function() {
        ...
        $('body').on('click', '.sa-params', function() {
            ...
            swal({
                title: "Are you sure?",
                text: "You will not be able to recover the deleted Storage Unit!",
                type: "warning",
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('admin.storage-units.destroy',':id') }}";
    ...
    function loadTable() {
        ...
        table = $('#listing-table').dataTable({
            ...
            serverSide: true,
            autoWidth: false,
            ajax: "{!! route('admin.storage-units.data') !!}",
            "order": [
                [0, "desc"]
            ],
            language: {
