        ...
        <div style="flex:auto">
            <div class="card">
                <div class="card-header bg-white header-elements-inline">
                    <h6 class="card-title">@lang('app.add') @lang('app.menu.products')</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="product_type" id="product_type" class="select2 form-control">
                                                ...
                                                @foreach($product_types as $type)
                                                    @if ($type == 'Item')
                                                        <option value="{{ $type }}">Item - Fixed</option>  
                                                    @endif
                                                    @if ($type == 'Service')
                                                        <option value="{{ $type }}">Service - Hourly</option>  
                                                    @endif
                                                    @if ($type == 'Charge')
                                    ...
                                    <div id="hourly_pricing_min_hours_div" class="col-md-6 hidden">
                                        <div class="form-group">                                            
                                            <label class="control-label">Minimum Hours</label>
                                            <input type="number" id="hourly_pricing_min_hours" step="0.01" name="hourly_pricing_min_hours" class="form-control">
                                        </div>
                                    </div>
                                    @if($xero_connected)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="xero_account_id" id="xero_account_id" class="select2 form-control">
                                ...
                                <div class="row">
                                    <div id="customer_id_div" class="col-md-6 hidden">
                                        <div class="form-group">
                                ...
                                <div class="row mt-3">
                                    <div id="stockable_div" class="col-md-6 hidden">
                                        <div class="form-group">
                                            <input type="checkbox" name="stockable" id="stockable">
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        ...
                                        <a href="{{ route('admin.products.index') }}" class="btn btn-light" data-dismiss="modal">Cancel</a>
                                    </div>
                                </div>
                            </div>
                            {!! Form::close() !!}
