{!! Form::open(['id'=>'createStatuses','class'=>'ajax-form','method'=>'POST']) !!}
@csrf
<div class="modal-header" style="border: 1px solid #f0f0f0;padding-bottom:10px">
    <span style="font-size:18px;font-weight: 400;">@lang('modules.statuses.addLeadStatus')</span>
        ...
        <div class="row">
            <div class="col-md-6 ">
                <div class="form-group">
                    ...
                    <input type="text" name="lead_status" id="lead_status" class="form-control" autocomplete="nope" required>
                </div>
            </div>
        </div>
    </div>
