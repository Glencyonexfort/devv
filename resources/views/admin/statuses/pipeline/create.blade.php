{!! Form::open(['id'=>'createPipelineStatuses','class'=>'ajax-form','method'=>'POST']) !!}
@csrf
<div class="modal-header" style="border: 1px solid #f0f0f0;padding-bottom:10px">
    <span style="font-size:18px;font-weight: 400;">@lang('modules.pipeline_statuses.addPipelineStatus')</span>
        ...
        <div class="row">
            <div class="col-md-6 ">
                <div class="form-group">
                    ...
                    <input type="text" name="pipeline_status" id="pipeline_status" class="form-control" autocomplete="nope" required>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 ">
                <div class="form-group">
                    ...
                    <select name="pipeline_id" data-placeholder="" class="form-control" required>
                        ...
                        <option value="{{ $pl->id }}">{{ $pl->pipeline }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
