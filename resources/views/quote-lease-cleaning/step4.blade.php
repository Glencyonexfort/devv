...
<div class="tab-pane active" role="tabpanel" id="step4">
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <div class="form-group">
                <textarea type="text" rows="2" name="other_details" id="other_details" class="form-control">{{($step4_ary['other_details'] ?? '')}}</textarea>
            </div>
        </div>
    </div>
    <ul class="list-inline text-center hr-top">
        <li class="pull-left"><a href="{{url('/quote-lease-cleaning/'.$tenant_id.'/'.$company_id.'/'.$city_id.'/'.$discount.'?step=3&session_data='. urlencode($session_data))}}" class="btn btn-default btn-next-step">Back</a></li>
