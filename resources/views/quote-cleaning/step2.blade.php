...
<div class="tab-pane active" role="tabpanel" id="step2">
    <p class="font-bold">Select Extras</p>
    ...
    <ul class="list-inline text-center hr-top">
        <li><a href="{{url('/quote-cleaning/'.$tenant_id.'/'.$company_id.'?step=1&session_data='. urlencode($session_data))}}" class="btn btn-default btn-next-step"><i class="fa fa-angle-left"></i> Back</a></li>
        <li><button type="submit" class="btn btn-primary btn-next-step  step2_nextBtn">Next <i class="fa fa-angle-right"></i></button></li>
    </ul>
</div>
{!! Form::close() !!}
<script>
