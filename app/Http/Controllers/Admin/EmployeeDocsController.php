...
class EmployeeDocsController extends AdminBaseController
{
    ...
    public function store(CreateRequest $request)
    {
        ...
        $this->employeeDocs = EmployeeDocs::where(['user_id' => $request->user_id, 'tenant_id' => auth()->user()->tenant_id])->get();
...
//        return view('admin.lead.lead-files.show', $this->data);
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $this->employeeDocs = EmployeeDocs::where(['user_id' => $file->user_id, 'tenant_id' => auth()->user()->tenant_id])->get();
