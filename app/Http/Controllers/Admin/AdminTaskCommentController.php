...
class AdminTaskCommentController extends AdminBaseController
{
    ...
    public function store(StoreTaskComment $request)
    {
        ...
        $this->comments = TaskComment::where(['task_id' => $request->taskId, 'tenant_id' => auth()->user()->tenant_id])->orderBy('id', 'desc')->get();
    ...
    public function destroy($id)
    {
        ...
        $comment->delete();
        $this->comments = TaskComment::where(['task_id' => $comment_task_id, 'tenant_id' => auth()->user()->tenant_id])->orderBy('id', 'desc')->get();
        $view = view('admin.tasks.task_comment', $this->data)->render();
