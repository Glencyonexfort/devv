...
class TicketChannelsController extends AdminBaseController
{
    ...
    {
        parent::__construct();
        $this->pageTitle = __('app.menu.ticketChannel');
    ...
    {
        $this->channels = TicketChannel::where(['tenant_id' => auth()->user()->tenant_id])->get();
    ...
    public function store(StoreTicketChannel $request)
    {
        ...
        $allChannels = TicketChannel::where(['tenant_id' => auth()->user()->tenant_id])->get();
