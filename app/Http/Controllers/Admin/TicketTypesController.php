...
class TicketTypesController extends AdminBaseController
{
    ...
    {
        parent::__construct();
        $this->pageTitle = __('app.menu.ticketTypes');
    ...
    {
        $this->ticketTypes = TicketType::where(['tenant_id' => auth()->user()->tenant_id])->get();
    ...
    public function store(StoreTicketType $request)
    {
        ...
        $allTypes = TicketType::where(['tenant_id' => auth()->user()->tenant_id])->get();
