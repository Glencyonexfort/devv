...
class MemberProjectsController extends MemberBaseController
{
    ...
    public function data(Request $request)
    {
        ...
        $projects = Project::with('members', 'members.user')
                ->select('projects.id', 'projects.project_name', 'projects.project_admin', 'projects.project_summary', 'projects.start_date', 'projects.deadline', 'projects.notes', 'projects.category_id', 'projects.feedback', 'projects.completion_percent', 'projects.created_at', 'projects.updated_at')
