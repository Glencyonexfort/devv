    ...
    return function(e) {
                ...
                return o.__extends(t, e), t.prototype.normalizeComponentFootprint = function(e) {
                    ...
                    for (var T = 0; T < l.length; T++) {
                        ...
                        for (var x = 0, M = r; x < M.length; x++) {
                            e = M[x];
                            var F = [n.getClass("widgetHeader")];
                            e.weekStart && F.push("fc-em-cell"), E && (F = F.concat(this.getDayClasses(e.date, !0))), C += '<th class="' + F.join(" ") + '" data-date="' + e.date.format() + '"' + (e.colspan > 1 ? ' colspan="' + e.colspan + '"' : "") + '><div class="fc-cell-content">' + e.spanHtml + "</div></th>"
                        }
                        C += "</tr>"
                    }
                    C += "</tbody></table>";
                    var z = '<table class="' + n.getClass("tableGrid") + '">';
                    z += "<colgroup>";
                    for (var _ = 0, B = h; _ < B.length; _++) e = B[_], z += "<col/>";
                    z += "</colgroup>", z += "<tbody><tr>";
                    for (var T = 0; T < h.length; T++) e = h[T], t = d[T], z += this.slatCellHtml(t, e.weekStart);
                    return z += "</tr></tbody></table>", {
                        headHtml: C,
                        bodyHtml: z
                    }
        ...
        var r = function() {
            ...
            return e.extractIds = function(t, r) {
                ...
                return null != t[o] && n.push(e.normalizeId(t[o])),
                    n
        ...
        var o = r(1),
            ...
            a = function(e) {
                ...
                return o.__extends(t, e), t.prototype.renderSkeleton = function() {
                    e.prototype.renderSkeleton.call(this), this.updateExpandingEnabled(), this.eventsPayload && s["default"].prototype.executeEventRender.call(this, this.eventsPayload), this.businessHourGenerator && s["default"].prototype.renderBusinessHours.call(this, this.businessHourGenerator), this.view.publiclyTrigger("resourceRender", {
